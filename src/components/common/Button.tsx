...
export default function Button({ label, type = BUTTON_TYPE.fill }: PropsType) {
  ...
  return (
    <button className={`${bgColor} ${textColor} ${border} ${borderColor} rounded-lg py-[15px] font-semibold`}>
      {label}
    </button>
  )
}